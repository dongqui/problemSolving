function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
  ...
  let decreasePercent = percentLossByMonth * 0.01;
  while (money + oldCarPrice - newCarPrice < 0) {
    month += 1;
    money += savingperMonth;
    if (month % 2 === 0) decreasePercent += 0.5 * 0.01;
    newCarPrice *= (1 - decreasePercent);
    oldCarPrice *= (1 - decreasePercent);
  }
  return [month, Math.round(money + oldCarPrice - newCarPrice)]
}
